...
func (c *authServiceClient) GetUserById(ctx context.Context, in *GetUserByIdRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
...
func (UnimplementedAuthServiceServer) GetUserById(context.Context, *GetUserByIdRequest) (*GetResponse, error) {
